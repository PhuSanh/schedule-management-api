...
func (gh GroupHandler) GetList(c echo.Context) (err error) {
...
func (gh GroupHandler) Create(c echo.Context) (err error) {
...
func (gh GroupHandler) Update(c echo.Context) (err error) {
...
func (gh GroupHandler) Delete(c echo.Context) (err error) {
	id := common.ParseParamID(c.Param("id"))
